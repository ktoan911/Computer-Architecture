...
#---------------------------------
	...
	nop
	jal STOP
goline4: addi $a0, $0, 180 # Marsbot rotates 90 * running and start running
	jal ROTATE
	nop
	jal GO
	nop
sleep4: addi $v0, $0, 32 # keep running by sleeping in 3000ms
	li $a0, 3000
	syscall

#--------------------------------------
	jal STOP
goline5: addi $a0, $0, 90 # Marsbot rotates 90 * running and start running
	jal ROTATE
	nop
	jal GO
	nop
sleep5: addi $v0, $0, 32 # keep running by sleeping in 4000ms
	li $a0, 4000
	syscall
	
#-------------------------------------
	jal STOP
goline6: addi $a0, $0, 310 # Marsbot rotates 90 * running and start running
	jal ROTATE
	nop
	jal GO
	nop
sleep6: addi $v0, $0, 32 # keep running by sleeping in 6100ms
	li $a0, 6000
	syscall
